				...
				pagination: {
					...
					renderBullet: function (index, className) {
						return (
							'<span class="' +
							className +
							' swiper-bullet--svg-animation"><svg width="30" height="30" viewBox="0 0 28 28"><circle class="svg__circle" style="animation-duration: ' +
							this.el.getAttribute('data-duration') +
							's" cx="14" cy="14" r="12" fill="none" stroke-width="2"></circle></svg></span>'
						)
					},
				},
				loop: true,
